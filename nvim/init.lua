...
if os.getenv("USER") == 'root' then
  vim.cmd('source ~\\AppData\\local\\nvim\\color\\Amythest.vim')
else
  vim.cmd('source ~\\AppData\\local\\nvim\\color\\Emerald.vim')
end

-- vim.cmd('source ' .. nvimrc .. 'color/Emerald.vim')   -- Use Emerald Legacy Color Scheme
vim.cmd('source ~\\AppData\\local\\nvim\\legacy\\netrw.vim')    -- Enable Legacy Netrw config until I refactor
vim.cmd('source ~\\AppData\\local\\nvim\\legacy\\brackets.vim') -- Enable Legacy brackets config until I refactor
vim.cmd('source ~\\AppData\\local\\nvim\\legacy\\comments.vim') -- Enable Legacy comments config until I refactor
vim.cmd('source ~\\AppData\\local\\nvim\\legacy\\comments.vim') -- Enable Legacy comments config until I refactor
