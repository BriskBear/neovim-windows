...
keymap.set('n', '<leader>init', ':execute "tabfind ~/AppData/local/nvim/init.lua"<CR>',           { desc = 'Edit [init].lua' })
keymap.set('n', '<leader>bra', ':execute "tabfind ~/AppData/local/nvim/legacy/brackets.vim"<CR>', { desc = 'Edit [bra]ckets' })
keymap.set('n', '<leader>key', ':execute "tabfind ~/AppData/local/nvim/lua/keymap.lua"<CR>',      { desc = 'Edit [key]map' })
